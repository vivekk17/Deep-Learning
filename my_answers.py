...
class NeuralNetwork(object):
    def __init__(self, input_nodes, hidden_nodes, output_nodes, learning_rate):
        ...
        #print ("initail weight input to hidden",self.weights_input_to_hidden,"\n weight hidden to output",self.weights_hidden_to_output)
    ...
    def train(self, features, targets):
        ...
        #print ("initail weight to 0",delta_weights_i_h,"\n weight hidden to output to t0",delta_weights_h_o)
        
        
        
        for X, y in zip(features, targets):
            #print ("feature",X,"target",y)
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        #print (output_error_term, hidden_error_term, X)
    ...
    def run(self, features):
        ...
        #print ("final_outputsaaaa",final_outputs)
